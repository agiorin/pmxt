...
import * as fetchPositionsModule from '../../../src/exchanges/limitless/fetchPositions';

jest.mock('../../../src/exchanges/limitless/auth');
jest.mock('../../../src/exchanges/limitless/fetchPositions');

describe('LimitlessExchange - Balance & Positions', () => {
    ...
    beforeEach(() => {
        ...
        exchange = new LimitlessExchange({ privateKey: '0x123' });
    });
